...
const ApplicantProfilePreview = ({
    ...
    const onChangeStatus = async (e) => {
        ...
        try {
            ...
            // optionaly revert status ifn  failed 
              ...
              <div className="p-6">
                  <div className="text-center mb-6 ">
                      {selectedApplicant.applicant.avatar ? (
                          ...
                          />
                              ...
                              <div className="h-20 w-20 rounded-full  bg-blue-100 items-center justify-center mx-auto">
                  ...
                  <div className="space-y-4 ">
                          ...
                          <div className="space-y-2">
                              ...
                              <div className="flex justify-between">
                                  ...
                                  <span className="text-gray-900">
                                      {
                                          moment(selectedApplicant.created)?.format('Do MM YYYY')
                                      }
                                  </span>
                              </div>
                          </div>
                      ...
                      <button
                          ...
                          className="w-full inline-flex items-center justify-center gap-2 px-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors"
                      >
