  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6 pb-4">
        ...
        {/* Main content */}
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 space-y-10">
          {/* Hero Section */}
          ...
          <div className="space-y-4">
            <h3 className="flex items-center space-x-3 text-base md:text-lg font-bold text-gray-900">
