    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex items-center h-16 border-b border-gray-200 pl-6">
          {!sidebarCollapsed ? (
            <Link className="flex items-center space-x-3" to="/">
              <div className="h-8 w-8 bg-gradient-to-br from-blue-600 to-blue-700 flex rounded-lg items-center justify-center">
                <Briefcase className="h-5 w-5 text-white" />
              </div>
              <span className="text-gray-900 font-bold text-xl">JobPortal</span>
            </Link>
          ) : (
            <div className="h-8 w-8 bg-gradient-to-br from-blue-700 rounded-xl flex items-center justify-center">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            className="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray hover:bg-gray-50 hover:text-gray-900 transition-all duration-200"
            onClick={logout}
          >
