...
const SalaryRangesSlider = ({filters,handleFilterChange}) => {
            ...
            <div className="grid grid-cols-2 gap-4 ">
                <div>
                   ...
                   <input
                    ...
                    value={minSalary || ''}
                    onChange={({ target }) => setMinSalary(target.value)}   // 👈 التغيير هنا
                    onBlur={() =>
                        handleFilterChange(
                        'minSalary',
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2 ">
                     ...
                     <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                        value={maxSalary || ''}
                        onChange={({ target }) => setMaxSalary(target.value)}   // 👈 بدل onClick
                        onBlur={() =>
                            handleFilterChange(
                            'maxSalary',
...
export default SalaryRangesSlider
