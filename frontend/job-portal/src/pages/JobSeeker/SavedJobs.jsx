...
import { ArrowLeft, Bookmark, Building2, Clock, DollarSign, Download, Edit3, Filter, Grid, List, Mail, MapPin, Search, Users, X } from "lucide-react";
...
const SavedJobs = () => {
  ...
  const handleUnsaveJob = async (jobId) => {
    try {
      const response = await axiosInstance.delete(API_PATHS.JOBS.UNSAVE_JOB(jobId));
          ...
          <div className="bg-white p-6 rounded-lg ">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {savedJobsList.length === 0 ? (
                <div className="text-center py-16 lg:py-20 bg-white/60 bachdrop-blur-xl rounded-2xl border border-white/20">
