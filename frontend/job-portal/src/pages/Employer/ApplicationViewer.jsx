  ...
  return (
    <DashboardLayout activeMenu='manage-jobs'>
      ...
      <div className='min-h-screen bg-gray-50'>
        {/**Header  */}
        <div className="mb-8">
          <div className="felx flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center  gap-4 mb-4 sm:mb-0 ">
              <button 
                onClick={() => navigate('/manage-jobs')}
                className='group flex items-cneter space-x-2 px-3 py-2 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border border-gray-200  hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl'
              >
                            ...
                            >
                              ...
                              <div className="flex items-center gap-4 ">
                                ...
                                <div className="min-w-0 flex-1 ">
                                  ...
                                  <div className="flex items-cneter gap-1 mt-1 text-gray-500 text-xs ">
                                    <Calendar className='h-3 w-3 ' />
                                    <span>
                                      Applied{' '}
                                      {moment(application.applicant.createdAt)?.format(
                                        'Do MM YYYY'
                                      )}
                                    </span>
                                  </div>
