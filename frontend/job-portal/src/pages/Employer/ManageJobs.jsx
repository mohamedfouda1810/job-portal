...
const [currentPage, setCurrentPage] = useState(1);
  ...
  // Pagination 
const totalPages = Math.ceil((filterAndSortedJobs?.length || 0) / itemsPerPage);
...
// TDelete specific  Job 
  ...
  // Decide which sort icon to display bassed on current sort field and direction 
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg
                 ...
                 bg-gray-50 placeholder-gray-400 outline-none transition-all duration-200"
              />
            </div>
            ...
            <div className="relative w-full sm:w-48">
              <select
                ...
                className="w-full pl-3 pr-8 py-2 text-sm border border-gray-200 rounded-lg 
                 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 
                 bg-gray-50 outline-none transition-all duration-200 appearance-none"
              >
          ...
          <div className="my-4">
            <p className="text-sm text-gray-600">
              Showing {paginatedJobs.length} of {filterAndSortedJobs.length} jobs
            </p>
          </div>
              ...
              <div className="w-[75vw] md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0">
                              <div className="flex space-x-2">
                                <button
                                  className="px-2 py-1 text-xs text-blue-600 hover:text-blue-800 p-2 rounded-lg hover:bg-blue-50 transition-colors duration-200"
                                  onClick={() =>
                                    navigate("/post-job", {
                                      state: { jobId: job.id },
                                    })
                ...
                {totalPages > 1 && (
                  <div className='mt-6 flex items-center justify-between '>
                    <div className='flex-1 felx justify-between sm:hidden'>
                      <button
                        onClick={() =>
                    ...
                    <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
                      <p className='text-sm text-gray-700'>
                        ...
                        of <span className='font-medium'>{filterAndSortedJobs.length}</span> results
                      </p>
                        ...
                        <button
                          onClick={() =>
                            setCurrentPage(Math.max(1, currentPage - 1))
                             ...
                             disabled={currentPage === 1}
                             className='relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 text-sm  bg-white font-meduim text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed '
                        >
                          Previous
                        </button>
