  ...
  return (
    <DashboardLayout activeMenu='employer'>
      {isLoading ?
        ...
        <div className='max-w-7xl mx-auto space-y-8'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 '>
            ...
            <StatCard
          title='Active jobs'
          value={dashboardData?.summary?.totalActiveJobs || 0}
          icon={Briefcase}
          trend={true}
          trendValue={`${dashboardData?.trends?.jobsPosted || 0}%`}
          color='blue'
        />

        <StatCard
          title='Total Applicants'
          value={dashboardData?.summary?.totalAppliedJobs || 0}
          icon={Users}
          trend={true}
        ...
        <StatCard
          title='Hired'
          value={dashboardData?.summary?.totalHired || 0}
          icon={CheckCircle2}
          trend={true}
      ...
      {/** Recent Activity  */} 
          ...
          >
            <div className='space-y-3'>
     {dashboardData?.recent?.applications
            ?.slice(0, 3)
            ?.map((app, index) => (
              <ApplicantDashboardCard
                ...
                time={moment(app?.createdAt).fromNow()}
              />
          ))}
