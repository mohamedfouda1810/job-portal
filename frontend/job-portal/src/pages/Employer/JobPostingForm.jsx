...
const JobPostingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('Failed to update or post job. please try again  ')
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      ...
      errors.salary = 'Both min salary and max salary  is Required '
          ...
          <div className='bg-white shadow-xl rounded-2xl p-6 '>
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    ...
                    helperText='Include key responsibilties, day-to-day tasks, and what makes this tole exciting '
                      required
                    />
                    ...
                    <div className='space-y-2 '>
                      <label className='block text-sm font-meduim text-gray-700'>
                        Salary Range <span className='text-red-500 '>*</span>
                      </label>
                      <div className='grid grid-cols-3 gap-3 '>
                        <div className='relative '>
                          <div className="absolute inset-y-0 left-0 pl-3 flex itesm-center pointer-events-none z-10  ">
                            <DollarSign className='h- w-5 text-gray-400' />
                          ...
                          <input 
                            ...
                            className='w-full pl-10 pr-3 py-2.5 border rounded-lg text-base  disabled:bg-gray-50 disabled:text-gray-500 focus:outline-none focus:ring-2 focus:ring-opacity-20 focus:border-blue-500 transition-colors duration-200'
                          />
                    ...
                    <div className='pt-2'>
                      <button
                        ...
                        className='w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-500 disabled:cursor-not-allowed outline-none transition-colors duration-200'>
                        {isSubmitting ? (
                          <>
